...
for altering its behavior.  These variables are:
  ...
  - org-grep-ellipsis :: This string is used to mark, in the hits
       ...
       is =[...]=.  Do not customize it with a string which likely
       appears frequently in your original text: all occurrences will
       be highlighted regardless if the ellipsis was real or not,
